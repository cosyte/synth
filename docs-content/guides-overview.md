...
> alongside the HL7 v2 message set (`ADT`, `ORU^R01`, `ORM^O01`, `SIU^S12`, `VXU^V04`); FHIR R4 /
> US Core (see the [FHIR guide](./guides-fhir)); C-CDA generation (CCD + Referral Note via
